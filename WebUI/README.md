...
[![Nuget](https://img.shields.io/nuget/v/SoftwareAteliers.WebUI.svg?style=flat&color=2196f3)](https://www.nuget.org/packages/SoftwareAteliers.WebUI/)
...
* Install the template from NuGet repository: `dotnet new -i SoftwareAteliers.WebUI`
